    ...
    <table class="table-auto w-full whitespace-normal overflow-hidden bg-white">
        <thead>
            <tr class="border-2 text-sm">
                ...
                <th class="text-start px-2 py-3 tracking-wider font-medium text-md">商品名</th>
                <th class="text-start py-3 tracking-wider font-medium text-md">作成日</th>
                <th class="text-center px-4 py-3 tracking-wider font-medium text-md">価格</th>
                <th class="text-center py-3 tracking-wider font-medium text-md">状態</th>
                <th class="text-start px-4 py-3 tracking-wider font-medium text-md">備考</th>
